<div class="container" >
    ...
    <div class="row justify-content-center mt-5" >
        <div class="col-lg-5 pt-0" >
            <div class="card o-hidden shadow-lg my-5 border-bottom-info" style="background-color: white;">
                            ...
                            <div class="p-5">
                                ...
                                <form class="user" method="post" action="<?= base_url('auth'); ?>">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id="email" name="email" placeholder="Masukan nim/nip atau email" value="<?= set_value('email'); ?>">
