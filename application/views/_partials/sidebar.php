...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center text-white">
        ...
        <div class="sidebar-brand-text mx-3">Lapor Yuk</div>
    </a>
                            ...
                            <?php else : ?>
                                ...
                                <?php if ($this->uri->segment(2) == "") : ?>
                                    ...
                                    <?php if ($this->uri->segment(2) == "pengaduan") : ?>
                                        ...
                                        <li class="nav-item">
                                        <?php endif; ?>
                                        <a class="nav-link pb-0" href="<?= site_url('mahasiswa/pengaduan'); ?>">
                                        ...
                                        <li class="nav-item">
                                            ...
                                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                                                <div class="bg-white py-2 collapse-inner rounded">
                                                    <h6 class="collapse-header">Daftar Pengaduan</h6>
                                                    <a class="collapse-item" href="<?= base_url('mahasiswa/selesai'); ?>">Disetujui</a>
                                                    <a class="collapse-item" href="<?= base_url('mahasiswa/proses'); ?>">Proses</a>
                                                    <a class="collapse-item" href="<?= base_url('mahasiswa/pending'); ?>">Pending</a>
                                                </div>
                                            </div>
                                        </li>
                                        <?php if ($this->uri->segment(2) == "profile") : ?>
